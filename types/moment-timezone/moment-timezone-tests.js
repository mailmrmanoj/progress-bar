...
a.tz();
var num = 1367337600000, arr = [2013, 5, 1], str = "2013-12-01", date = new Date(2013, 4, 1), mo = moment([2013, 4, 1]), obj = { year: 2013, month: 5, day: 1 }, format = "YYYY-MM-DD", formats = ["YYYY-MM-DD", "YYYY/MM/DD"], formatsIncludingSpecial = ["YYYY-MM-DD", moment.ISO_8601], language = "en";
moment.tz();
...
zone.parse(Date.UTC(2012, 2, 19, 8, 30));
...
//# sourceMappingURL=moment-timezone-tests.js.map